...
<div class="bg-client-form">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body" style="color: #337ab7">
            <?php $form = ActiveForm::begin(['id' => $model->formName(), 'type' => ActiveForm::TYPE_HORIZONTAL, 'disabled' => !Yii::$app->user->can('createGuard') ? true : false]); ?>
...
$('form#{$model->formName()}').on('beforeSubmit', function(e){
    ...
    .done(function(data){
        if(data){
            $('#bgunit-id_client').html(data);
            $('#bgunit-id_client').select2("val")

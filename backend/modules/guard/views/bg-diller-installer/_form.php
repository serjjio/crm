...
<div class="bg-diller-installer-form">
        	...
        	<?php $form = ActiveForm::begin(['id' => $model->formName(), 'type' => ActiveForm::TYPE_HORIZONTAL, 'enableAjaxValidation' => true, 'disabled' => !Yii::$app->user->can('createGuard') ? true : false]); ?>
        		...
        		<div class="form-group">
            		<div class="col-sm-2" style="text-align: left">
                		<?= Html::activeLabel($model, 'id_diller_installer', ['label' => 'Имя диллера'])?>
            		</div>      
            		<div class="col-sm-4">
                		<?= $form->field($model, 'name_diller_installer', ['showLabels' => false])->textInput()?>
            		</div>     
        		</div>
        		...
        		<div class="form-group">
            		<div class="col-sm-2" style="text-align: left">
                		<?= Html::activeLabel($model, 'id_diller_installer', ['label' => 'Город'])?>
	            	</div>      
	            	<div class="col-sm-4">

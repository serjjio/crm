...
class BgUnitSearch extends BgUnit
{
    ...
    public function rules()
    {
        return [
            ...
            [['sim_number', 'test_date', 'id_type_unit', 'installer', 'contact_installer', 'vin_number', 'activate_date', 'garant_term', 'name_model', 'gos_number', 'color', 'made_auto_date', 'passport_number', 'name_owner', 'comment', 'id_model', 'id_client'], 'safe'],
        ];
    }

...
<!-- -------------------------------------------------------------------------------------------------------------------------------------- -->
			            <!-- PASSWORD -->
			           		<div class="form-group">
					            <div class="col-sm-3" style="text-align: left">
					                <?= Html::activeLabel($model, 'id', ['label' => 'Новый пароль'])?>
					            </div>
				                <div class="col-sm-8 right-help">
				                    <?= $form->field($model, 're_new_password', ['showLabels' => false])->passwordInput(['placeholder' => 'password'])?>
				                </div>
		            		</div>
		            		<div class="form-group">
					            <div class="col-sm-3" style="text-align: left">
...
<!-- ----------------------------------------------------------------------------------------------------------------------------------------- -->	            		
	            		...
	            		<div class="form-group">
		            		<div class="col-sm-5">
		            			<?= $form->field($model, 'permission', ['showLabels' => false])->checkboxList($permissions_list, ['value' => $permission_user])?>
		            		</div>
	            		</div>          		
